...
class EventPushActionsStoreTestCase(HomeserverTestCase):
    ...
    def test_count_aggregation_threads(self) -> None:
        ...
        thread_id = _inject_actions()
        _assert_counts(1, 0, 0, 0, 0, 0)
        _rotate()
        _assert_counts(1, 0, 0, 0, 0, 0)

        _inject_actions(thread_id=thread_id)
        ...
        event_id = _inject_actions(thread_id=thread_id)
        ...
        event_id = _inject_actions(True, thread_id)
        ...
        _inject_actions(True)
        _inject_actions(True, thread_id)
        _assert_counts(1, 1, 1, 1, 1, 1)
        _mark_read(last_event_id)
        _assert_counts(0, 0, 0, 0, 0, 0)
        _rotate()
